...
var play18 = document.getElementById("filme18-h1");

var play18Film = document.getElementById("filme18-player");
...
play18.addEventListener("click",

    function(){

        play18.style.display = "none";

        play18Film.style.display= "inherit"
...
off.addEventListener("click",
                ...
                function(){                    
                    ...
                    if (count18==2){
                        ...
                        if (play18Film.style.display == "inherit"){

                            play18Film.style.display = "none";

                            play18.style.display = "inherit";

                            // turn off video after display:none;

                            var videoSource=play18Film.getAttribute('src');

                            play18Film.setAttribute('src', '');

                            play18Film.setAttribute('src', videoSource);
                        }
